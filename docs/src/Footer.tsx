export default function Footer() {
    return (
        <div id="footer" className="mt-48 mb-8 w-full flex justify-center">
            <div className='w-2/5 flex justify-between gap-16 text-neutral-400 items-center fira-code-font text-sm'>
