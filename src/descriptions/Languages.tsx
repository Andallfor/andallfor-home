...
export function Lng_CPlusPlus() {
    return (
        <div>
            ...
            <div className="indent-6">
                I starting learning <a className="link-blue-2 font-semibold" target="_blank" href="https://cplusplus.com/">C++</a> from the John Hopkins <a className="link-blue-2 font-semibold" target="_blank" href="https://e-catalogue.jhu.edu/course-descriptions/computer_science_601/">Intermediate Programming</a> class (teaching data structures and C/C++), in which I received in A+. I also completed UMD's <a className="link-blue-2 font-semibold" target="_blank" href="https://academiccatalog.umd.edu/undergraduate/approved-courses/cmsc/">Computer Systems</a> class (C and Assembly) with an A+ as well. Between the class and working on my own personal projects, I have gained experience using features such as memory management, structs, templates, and function pointers.
            </div><br/>
            <div className="indent-6">
